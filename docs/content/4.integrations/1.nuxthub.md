...
Create application tables that reference auth tables by importing `schema` from `@nuxthub/db`. NuxtHub automatically merges your custom schemas with Better Auth tables.
